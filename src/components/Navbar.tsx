      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between h-20 items-center">
          ...
          <div className="hidden md:flex space-x-8">
            ...
            <a href="#portfolio" className="text-gray-300 hover:text-[#2cd4bd] transition">Portfolio</a>
            <a href="#process" className="text-gray-300 hover:text-[#2cd4bd] transition">Processo</a>
      ...
      {isOpen && (
        <div className="md:hidden bg-black/95">
          <div className="px-2 pt-2 pb-3 space-y-1 sm:px-3">
            ...
            <a href="#portfolio" className="block px-3 py-2 text-gray-300 hover:text-[#2cd4bd] transition">Portfolio</a>
            <a href="#process" className="block px-3 py-2 text-gray-300 hover:text-[#2cd4bd] transition">Processo</a>
